      ...
      <div className="bg-[#EEEEEE] w-[552px] h-[457px] rounded-3xl absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 border-2 border-[#393E46]">
        ...
        <form action="" className="mt-5 w-3/4 mx-auto">
          ...
          <div className="border-2 border-[#393E46] rounded-xl flex items-center h-10">
            <input ref={passwordType} type="password" id="password" className="block text-lg w-5/6 py-2 px-3 outline-none bg-transparent rounded-xl" />

            {showPassword?    <svg onClick={handleShowPassword} className="ml-4" width="20" height="20" viewBox="0 0 30 20"  xmlns="http://www.w3.org/2000/svg">
              <path
              ...
              <svg onClick={handleShowPassword} className="h-[30px] w-[20px] ml-4" width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
